...
<body>
	...
	<div class="container" style="background-color: white;">
		...
		<div class="alinhamento-esquerdo">
			<h2>
				<b>Sinais executados por intérpretes</b>
			</h2>
			<br /> <br />
		</div>
		<script>
							...
							<div class="center-block">
								<c:forEach items="${unidade.sinais}" var="sinal">
									<a href="mostraSinal?id=${sinal.idSinal}">
										<div
											class="col-sm-offset-0 col-sm-6 col-md-3 col-xs-offset-1 col-xs-10 box-sinal-libras-simples">
											<div
												class="img-responsive box-img-sinal-libras col-sm-4 col-xs-4">
												<img class="img-sinal-libras img-responsive center-block"
													src="${pageContext.request.contextPath}/resources/img/${sinal.foto}" />
											</div>
											<div
												class="col-sm-8 col-xs-8 text-center box-sinal-descricao">
												<h4>${sinal.nome}</h4>
												<div class="sinal-dificuldade">${sinal.dificuldade}</div>
												<div class="estrela-nota-sinal"
													id="estrelas-nota-${sinal.idSinal}"></div>
												<script>
													listaIdSinais
															.push('${sinal.idSinal}');
												</script>
