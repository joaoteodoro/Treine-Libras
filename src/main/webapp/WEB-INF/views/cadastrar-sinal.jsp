			...
			<div class="row">
				<div class="center-block box-page-geral">
					<form id="form" action="javascript:alert( 'success!' );">
						...
						<div class="form-group">
							<label for="configuracaoMao">Configuração de Mão:</label>
							<input type="text" required class="form-control" id="configuracaoMao" placeholder="Configuração de Mão"
						...
						<div class="form-group">
							<label for="pontoArticulacao">Ponto de Articulação:</label>
							...
							<div style="display: none" id="outroPontoArticulacao">
								<br/>
								<input type="text" class="form-control" id="pontoArticulacao2" placeholder="Novo Ponto de Articulação">
							</div>
						</div>
						...
						<div class="form-group">
							<label for="expressaoFacial">Expressão Facial:</label>
						...
						<div class="form-group">
							...
							<input type="file" required class="form-control" id="video" placeholder="Vídeo" accept="video/*">
