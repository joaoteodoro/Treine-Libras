...
<title>Treine Libras - Cadastrar Configuração de Mão</title>
...
<body style="background-color: gray">
	...
	<div class="container" style="background-color: white;">
		...
		<div class="alinhamento-esquerdo">
			<h2>
				<b>${logica[0]} Configuração de Mão</b>
			</h2>
			<br /> <br />
		</div>
		<div class="row">
			...
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					<div class="modal-header">
						...
						<h4 class="modal-title" id="myModalLabel">${logica[0]} - Configuracao De Mão</h4>
					</div>
					<div class="modal-body">Confirma ${logica[1]} desta Configuração de Mão?</div>
